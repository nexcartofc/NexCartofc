    ...
    <div className="flex flex-col gap-8 lg:flex-row min-h-[80vh]">
      ...
      <aside className="w-full lg:w-64 flex-shrink-0 space-y-2 rounded-[32px] border bg-white p-4 h-fit sticky top-24">
        <div className="mb-6 flex items-center gap-3 px-4 py-2 border-b">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-orange-600 text-white shadow-lg shadow-orange-100">
            <Store size={20} />
          </div>
        ...
        <button 
          ...
          className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "dashboard" ? "bg-orange-600 text-white shadow-lg shadow-orange-100" : "text-neutral-600 hover:bg-neutral-50"}`}
        >
          <BarChart2 size={18} /> Dashboard
        </button>
        <button 
          onClick={() => setActiveTab("inventory")}
          className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "inventory" ? "bg-orange-600 text-white shadow-lg shadow-orange-100" : "text-neutral-600 hover:bg-neutral-50"}`}
        >
          <Package size={18} /> Inventory
        </button>
        <button 
          onClick={() => setActiveTab("earnings")}
          className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "earnings" ? "bg-orange-600 text-white shadow-lg shadow-orange-100" : "text-neutral-600 hover:bg-neutral-50"}`}
        >
          <DollarSign size={18} /> Earnings
        </button>
        <button 
          onClick={() => setActiveTab("settings")}
          className={`flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold transition-all ${activeTab === "settings" ? "bg-orange-600 text-white shadow-lg shadow-orange-100" : "text-neutral-600 hover:bg-neutral-50"}`}
        >
          ...
          <div className="space-y-8">
             <section className="grid gap-6 sm:grid-cols-3">
              ...
              <div className="rounded-3xl border bg-white p-6">
                ...
                <p className="mt-2 text-xs font-bold text-blue-600">Pending: 12</p>
              </div>
              <div className="rounded-3xl border bg-white p-6">
                ...
                <p className="mt-2 text-xs font-bold text-orange-600">High engagement</p>
              </div>
            </section>
            ...
            <section className="rounded-[40px] border bg-white p-8 md:p-12 shadow-sm shadow-neutral-100">
              ...
              <div className="grid gap-8 md:grid-cols-2">
                ...
                <div className="space-y-6">
                  ...
                  <div className="aspect-video w-full rounded-3xl border-2 border-dashed border-neutral-200 bg-neutral-50 flex flex-col items-center justify-center p-8 text-neutral-400 hover:border-orange-300 hover:bg-orange-50 transition-all cursor-pointer">
              ...
              <div className="mt-12 flex justify-end">
                ...
                <Button className="h-14 px-12 text-lg bg-orange-600 hover:bg-orange-700 ml-4">
                  Publish Product
                </Button>
              </div>
            </section>
